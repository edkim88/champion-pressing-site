...
export const metadata: Metadata = {
  ...
  title: "Champion Pressing | 국내 엘피(LP) 제작 및 바이닐 프레싱 팩토리",
  description: "최고의 퀄리티를 자랑하는 국내 엘피(LP) 제작 업체 챔피언 프레싱. 오리지널 사운드를 온전히 담아내는 프리미엄 바이닐 팩토리입니다.",
  keywords: ["엘피제작", "엘피제작업체", "국내 엘피제작 업체", "LP제작", "바이닐 레코드", "LP 프레싱", "바이닐 프레싱", "챔피언 프레싱"],
  openGraph: {
