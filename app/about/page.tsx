...
export default function About() {
  ...
  const dict = {
    ...
    ko: {
      ...
      standardDesc2: <>데뷔 EP를 준비하는 독립 아티스트부터 클래식 명반을 재발매하는 대형 레거시 레이블까지, 우리가 레코드를 대하는 태도는 동일합니다.<br className="hidden md:block" />타협 없는 정밀도, 투명한 커뮤니케이션, 그리고 바이닐 그루브에 새겨지는 음악에 대한 깊은 존중입니다.</>,
      readyDesc: <>여러분의 다음 프로젝트에 대한 이야기를 들려주세요.<br className="hidden md:block" />치열하게 고민한 사운드를 가장 완벽한 물리적 매체로 완성해 드립니다.</>,
      makeQuoteBtn: "Make a Quote",
      backToTopBtn: "Back to Top"
    }
  };
